"""
Django settings for sweetbite project.
...
WSGI_APPLICATION = 'sweetbite.wsgi.application'
...
if 'USE_AWS' in os.environ:
    ...
    # Bucket Config
    AWS_STORAGE_BUCKET_NAME = 'sweetbite-chocolate-shop'
