...
def calculate_discounted_price(product):
    ...
    Returns:
    float: The discounted price if a discount is applicable, otherwise the original price.
    """
    ...
    if discounts.exists():
        ...
        discounted_price = product.price * (1 - Decimal(discount.discount_percentage) / Decimal(100))
